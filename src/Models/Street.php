...
class Street extends Model implements ImportInterface
{
    /**
    ...
    public function import(array $data)
    {
        ...
        if (!$this->save()) {
            throw new EcontException("Error importing street {$this->id}, named {$this->name}.");
        }
    }
