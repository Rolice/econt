...
Route::group(['prefix' => 'econt'], function () {
    ...
    Route::get('streets', ['as' => 'econt.streets', 'uses' => 'Rolice\Econt\Http\Controllers\StreetController@streets']);
    Route::get('streets/autocomplete', ['as' => 'econt.streets.autocomplete', 'uses' => 'Rolice\Econt\Http\Controllers\StreetController@streets']);
